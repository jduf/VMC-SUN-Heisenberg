...
mc_SRCS=   mc.cpp    CreateSystem.cpp ChainFermi.cpp ChainPolymerized.cpp SquarePiFlux.cpp Lapack.cpp Parseur.cpp IOFiles.cpp Read.cpp Write.cpp Header.cpp RST.cpp PSTricks.cpp Rand.cpp Gnuplot.cpp
#min_SRCS= min.cpp   CreateSystem.cpp ChainFermi.cpp ChainPolymerized.cpp SquarePiFlux.cpp Lapack.cpp Parseur.cpp IOFiles.cpp Read.cpp Write.cpp Header.cpp RST.cpp PSTricks.cpp Rand.cpp  Minimization.cpp
check_SRCS=check.cpp CreateSystem.cpp ChainFermi.cpp ChainPolymerized.cpp SquarePiFlux.cpp Lapack.cpp Parseur.cpp IOFiles.cpp Read.cpp Write.cpp Header.cpp RST.cpp PSTricks.cpp Rand.cpp Gnuplot.cpp
study_SRCS=study.cpp CreateSystem.cpp ChainFermi.cpp ChainPolymerized.cpp SquarePiFlux.cpp Lapack.cpp Parseur.cpp IOFiles.cpp Read.cpp Write.cpp Header.cpp RST.cpp PSTricks.cpp RSTFile.cpp Gnuplot.cpp Directory.cpp
