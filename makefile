...
# monte-carlo
#############
mc:mc.o MonteCarlo.o System.o Lapack.o Rand.o Read.o Write.o Header.o RST.o Chrono.o
	$(CXX) -o $@ $^ $(LDFLAGS)
...
MonteCarlo.o:MonteCarlo.cpp MonteCarlo.hpp System.hpp Array2D.hpp Matrice.hpp Write.hpp Rand.hpp Chrono.hpp Parseur.hpp
	$(CXX) -c $(CXXFLAGS) $^ 
